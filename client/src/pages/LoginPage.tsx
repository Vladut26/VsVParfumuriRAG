...
const LoginPage: FC = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      toast.addToast("Bun venit! 🎉", "success");
      navigate("/");
    } catch {
      toast.addToast("Email sau parola incorecta.", "error");
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-[var(--noir)]">
        <div className="absolute inset-0 bg-gradient-to-br from-[var(--noir)] via-[var(--noir)]/90 to-[var(--gold-dark)]/20" />
        <div className="relative z-10 flex flex-col justify-between p-12 text-white">
          ...
          <div>
            <h2 className="text-4xl font-serif font-bold leading-tight mb-4">
              Descopera lumea<br />
              <span className="text-[var(--gold)]">parfumurilor</span><br />
              de lux
            </h2>
            <p className="text-white/50 text-sm max-w-sm leading-relaxed">
              Conecteaza-te pentru a accesa recomandari personalizate AI, 
              lista de favorite si istoricul comenzilor tale.
            </p>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 bg-[var(--cream)]">
        <div className="w-full max-w-md">
          ...
          <h1 className="text-3xl font-serif font-bold text-[var(--noir)] mb-2">Bine ai revenit</h1>
          <p className="text-gray-400 text-sm mb-8">Conecteaza-te la contul tau</p>
          ...
          <p className="text-center text-sm text-gray-500">
            Nu ai cont?{" "}
            <Link to="/register" className="text-[var(--gold-dark)] font-semibold hover:underline underline-offset-4">
